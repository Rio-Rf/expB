...
public class CodeGenStatementAssignTest {
    ...
    @Test
    public void assignPint() throws FatalErrorException {
    ...
    @Test
    public void assignPintMult() throws FatalErrorException {
        inputStream.setInputString("*ip_a=1;");
        String expected[] = {
            "	MOV	#ip_a, (R6)+",
            "   MOV	-(R6), R0",
    ...
    // (2.5) 2命令の扱い
    @Test
    public void assignTwo() throws FatalErrorException {
        ...
        // Check only code portion, not validate comments
        CParseRule rule = new Program(cpContext); // Programに変更
        helper.checkCodeGen(expected, rule, cpContext);
    }
    ...
    @Test
    public void assignArrayPint() throws FatalErrorException {
    ...
    @Test
    public void assignArrayPintMult() throws FatalErrorException {
        inputStream.setInputString("*ipa_a[3]=3;");
        String expected[] = {
            "	MOV	#ipa_a, (R6)+",
            "	MOV	#3, (R6)+",
