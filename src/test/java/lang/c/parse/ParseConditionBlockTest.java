...
public class ParseConditionBlockTest {
    ...
    // '(' のあとに condition がない
    @Test
    public void parseErrorForNoCondition()  {
        String[] testDataArr = {"("};
        for ( String testData: testDataArr ) {
            resetEnvironment();
            inputStream.setInputString(testData);
            ...
            try {
                ...
                assertThat(e.getMessage(), containsString("'('の後ろはconditionです"));
            }
        }
    }
    ...
    // condition のあとに ')' がない
    @Test
    public void parseErrorForNoRPAR()  {
        ...
        for ( String testData: testDataArr ) {
            ...
            try {
                ...
                assertThat(e.getMessage(), containsString("conditionの後ろは')'です"));
            }
        }
    }
